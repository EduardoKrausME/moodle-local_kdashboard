...
if (isset($_FILES["file"]["name"])) {
    ...
    if (in_array($extension, $aloweb)) {
        ...
        $url = moodle_url::make_file_url(
            ...
            "/{$contextid}/local_kdashboard/{$filerecord->filearea}/{$filerecord->itemid}{$filerecord->filepath}{$filerecord->filename}");
...
foreach ($files as $file) {
    $url = moodle_url::make_file_url(
        "$CFG->wwwroot/pluginfile.php",
        "/{$contextid}/local_kdashboard/{$file->get_filearea()}/{$file->get_itemid()}{$file->get_filepath()}{$file->get_filename()}");
    $items[] = [
