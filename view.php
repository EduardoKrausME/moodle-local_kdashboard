...
define("LOCAL_KDASHBOARD_BENCHSTART", microtime(true));
require_once("../../config.php");
define("LOCAL_KDASHBOARD_BENCHSTOP", microtime(true));
...
if ($html = optional_param("html-pdf", false, PARAM_RAW)) {
    \local_kdashboard\report\pdf::create_pdf();
    die();
}
...
$PAGE->set_url(new moodle_url("/local/kdashboard/view.php", url_util::params()));
