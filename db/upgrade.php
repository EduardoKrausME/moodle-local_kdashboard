...
function xmldb_local_kdashboard_upgrade($oldversion) {
    ...
    if ($oldversion < 2024101500) {
        set_config("menu", $CFG->kopere_dashboard_menu, "local_kdashboard");
        set_config("menuwebpages", $CFG->kopere_dashboard_menuwebpages, "local_kdashboard");
        set_config("monitor", $CFG->kopere_dashboard_monitor, "local_kdashboard");
        set_config("pagefonts", $CFG->kopere_dashboard_pagefonts, "local_kdashboard");
