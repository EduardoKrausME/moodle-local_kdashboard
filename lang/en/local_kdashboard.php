...
$string['kdashboard_menu'] = 'Show menu in top bar';
$string['kdashboard_menu_desc'] = 'If checked, the top menu contains a link to the Kopere Dashboard';
$string['kdashboard_menuwebpages'] = 'Show static pages for logged-in users';
$string['kdashboard_menuwebpages_desc'] = 'Enable this option to display static pages in the navigation menu for logged-in users.';
$string['kdashboard_monitor'] = 'Server Monitor';
$string['kdashboard_monitor_desc'] = 'Do you want to display the server monitor at the top of Kopere?';
$string['kdashboard_pagefonts'] = 'Google Extra Fonts';
$string['kdashboard_pagefonts_desc'] = 'Add here the @import link from Google for extra fonts.<br>You can put multiple import.<br><a href="https://fonts.google.com/selection/embed" target="google">Embed code</a><br><img src="{$a}" style="max-width: 100%;width: 420px;">';
...
$string['messageprovider:kdashboard_messages'] = 'Send Notifications';
...
$string['notification_local_kdashboard'] = 'Kopere Dashboard';
$string['notification_local_kdashboard_payment'] = 'Kopere Payment';
$string['notification_local_khotmoodle'] = 'Kopere HotMoodle';
$string['notification_local_kmoocommerce'] = 'Kopere MooCommerce';
$string['notification_local_kpay'] = 'Kopere Pagamento';
...
$string['privacy:metadata'] = 'The Kopere Dashboard does not store user data.';
