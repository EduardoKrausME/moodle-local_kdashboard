...
/**
 * Class local_kdashboard_reprt
 *
 * @package local_kdashboard\vo
 */
class local_kdashboard_reprt extends \stdClass {
     ...
     * @param $item
     *
     * @return local_kdashboard_reprt
     * @throws \coding_exception
     */
    public static function create_by_object($item) {
        $return = new local_kdashboard_reprt();
