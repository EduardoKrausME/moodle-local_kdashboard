...
/**
 * Class local_kdashboard_rcat
 *
 * @package local_kdashboard\vo
 */
class local_kdashboard_rcat extends \stdClass {
     ...
     * @param $item
     *
     * @return local_kdashboard_rcat
     * @throws \coding_exception
     */
    public static function create_by_object($item) {
        $return = new local_kdashboard_rcat();
