...
/**
 * Class local_kdashboard_event
 *
 * @package local_kdashboard\vo
 */
class local_kdashboard_event extends \stdClass {
    /** @var int */
    public $id;
    ...
    public static function create($module, $eventname, $userfrom, $userto, $subject, $message = null) {
        $event = new local_kdashboard_event();
        $event->module = $module;
    ...
    public static function create_by_object($item) {
        $return = new local_kdashboard_event();
