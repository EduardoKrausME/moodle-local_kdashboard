...
/**
 * Class local_kdashboard_pages
 *
 * @package local_kdashboard\vo
 */
class local_kdashboard_pages extends \stdClass {
     ...
     * @param $item
     *
     * @return local_kdashboard_pages
     * @throws \coding_exception
     */
    public static function create_by_object($item) {
        $return = new local_kdashboard_pages();
