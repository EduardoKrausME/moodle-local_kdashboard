...
class webpages {
    ...
    public function dashboard() {
        ...
        dashboard_util::start_page(local_kdashboard_makeurl("webpages", "settings"), "Páginas-estáticas");

        $botao = button::add(get_string_kopere("webpages_menu_create"),
            local_kdashboard_makeurl("webpages", "menu_edit"), "ml-4", false, true);
        ...
        if (!$menus) {
            ...
            foreach ($menus as $key => $menu) {
                ...
                $bt1 = button::icon_popup_table("edit",
                    local_kdashboard_makeurl("webpages", "menu_edit", ["id" => $menu->id]));
                $bt2 = button::icon_popup_table("delete",
                    local_kdashboard_makeurl("webpages", "menu_delete", ["id" => $menu->id]));
                $menu->htmlid = "
                    <img src='{$detailsopen}'
    ...
    public function menu_get_itens() {
        ...
        echo button::add(get_string_kopere("webpages_page_create"),
            local_kdashboard_makeurl("webpages", "page_edit", ["menuid" => $menuid]), "", false, true);
        echo button::add(get_string_kopere("webpages_menu_create"),
            local_kdashboard_makeurl("webpages", "menu_edit", ["menuid" => $menuid]), "ml-4", false, true);
        ...
        foreach ($pages as $key => $page) {
            ...
            $bt1 = button::icon("details",
                local_kdashboard_makeurl("webpages", "page_details", ["id" => $page->id]));
            $bt2 = button::icon_popup_table("delete",
                local_kdashboard_makeurl("webpages", "page_delete", ["id" => $page->id]));
            $page->actions = "
                <div class='text-center'>
                    {$bt1}
                    &nbsp;&nbsp;&nbsp;
    ...
    public function page_details() {
        ...
        dashboard_util::add_breadcrumb(get_string_kopere("webpages_title"),
            local_kdashboard_makeurl("webpages", "dashboard"));
        ...
        button::edit(get_string_kopere("webpages_page_edit"),
            local_kdashboard_makeurl("webpages", "page_edit",
                ["id" => $webpages->id]), "margin-left-15", false);
        button::delete(get_string_kopere("webpages_page_delete"),
            local_kdashboard_makeurl("webpages", "page_delete",
        ...
        if ($webpages->courseid) {
            ...
            if ($course) {
                $url = local_kdashboard_makeurl("courses", "page_details",
    ...
    public function page_edit() {
        ...
        if (!$webpages) {
            ...
            dashboard_util::add_breadcrumb(get_string_kopere("webpages_title"),
                local_kdashboard_makeurl("webpages", "dashboard"));
            dashboard_util::add_breadcrumb($webpages->title,
                local_kdashboard_makeurl("webpages", "page_details", ["id" => $webpages->id]));;
        ...
        $form = new form(local_kdashboard_makeurl("webpages", "page_edit_save"));
    ...
    public function page_delete() {
        ...
        if ($status == "sim") {
            ...
            header::location(local_kdashboard_makeurl("webpages", "dashboard"));
        }
        ...
        button::delete(get_string("yes"),
            local_kdashboard_makeurl("webpages", "page_delete", ["status" => "sim", "id" => $webpages->id]), "", false);
    ...
    public function menu_edit() {
        ...
        $form = new form(local_kdashboard_makeurl("webpages", "menu_edit_save"));
    ...
    public function menu_delete() {
        ...
        dashboard_util::add_breadcrumb($menu->title,
            local_kdashboard_makeurl("webpages", "page_details", ["id" => $menu->id]));
        ...
        if ($pages) {
            ...
            button::delete(get_string("yes"),
                local_kdashboard_makeurl("webpages", "menu_delete",
    ...
    public function settings() {
        ...
        $form = new form(local_kdashboard_makeurl("settings", "save", ["redirect" => $redirect]));
