...
use local_kdashboard\html\inputs\input_date_range;
...
class userenrolment {
    ...
    public function mathedit() {
        ...
        $form = new form(local_kdashboard_makeurl("userenrolment", "mathedit_save"));
        ...
        $PAGE->requires->js_call_amd("local_kdashboard/userenrolment", "userenrolment_status");
