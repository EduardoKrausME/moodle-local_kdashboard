...
namespace local_kdashboard\task;

/**
 * Class db_report_login
 *
 * @package local_kdashboard\task
 */
class db_report_login extends \core\task\scheduled_task {
    ...
    public function get_name() {
        return get_string("crontask_db_report_login", "local_kdashboard");
    }
    ...
    public function execute() {
        ...
        $DB->delete_records("local_kdashboard_login");
        ...
        foreach ($logstorestandardlogs as $logstorestandardlog) {
            ...
            try {
                $DB->insert_record("local_kdashboard_login", $data);
