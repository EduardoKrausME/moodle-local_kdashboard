...
use local_kdashboard\html\inputs\input_base;
use local_kdashboard\html\inputs\input_email;
...
use local_kdashboard\util\enroll_util;
...
class courses {
    ...
    public function details() {
        ...
        echo "</div>";
        $PAGE->requires->js_call_amd("local_kdashboard/course", "courses_enrol_new");
    ...
    public function create_static_page($course) {
        ...
        if ($menus) {
            ...
            $webpagess = $DB->get_records("local_kdashboard_pages", ["courseid" => $course->id]);
