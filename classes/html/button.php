...
class button {
    ...
    public function to_string($text, $paragraph = true, $return = false) {
        ...
        $bt = $OUTPUT->render_from_template("local_kdashboard/html-button", $data);
    ...
    public static function icon_confirm($icon, $link, $confirmtext, $confirmtitle) {
        ...
        $PAGE->requires->js_call_amd("local_kdashboard/button_icon", "action",
            [$data["button_id"], $data["link"]]);
        return $OUTPUT->render_from_template("local_kdashboard/html-button_icon", $data);
    }
