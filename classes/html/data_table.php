...
namespace local_kdashboard\html;

use local_kdashboard\util\export;
use local_kdashboard\util\number_util;
use local_kdashboard\util\url_util;

/**
 * Class data_table
 *
 * @package local_kdashboard\html
 */
class data_table {
    /** @var array */
    private $column = [];
    ...
    public function close($processserver = false, $extras = null, $returnhtml = false, $title = false) {
        ...
        if (isset($json[800])) {
            ...
            $PAGE->requires->js_call_amd("local_kdashboard/dataTables_init", "init", [$this->tableid, null]);
        } else {
            $PAGE->requires->js_call_amd("local_kdashboard/dataTables_init", "init", [$this->tableid, $initparams]);
        }
    ...
    private function on_clickreditect() {
        ...
        $PAGE->requires->js_call_amd("local_kdashboard/dataTables_init", "click",
