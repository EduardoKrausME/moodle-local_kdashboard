...
/**
 * Privacy Subsystem implementation for local_kdashboard.
 *
...
namespace local_kdashboard\privacy;
...
/**
 * The local_kdashboard module does not store any data.
 */
class provider implements
    ...
    public static function get_contexts_for_userid(int $userid): \core_privacy\local\request\contextlist {
        ...
        $contextlist->set_component("local_kdashboard");
    ...
    public static function delete_data_for_all_users_in_context(context $context) {
        ...
        $DB->delete_records_select("local_kdashboard_login", "userid = :userid", $where);
        $DB->delete_records_select("local_kdashboard_acess", "userid = :userid", $where);
    }
