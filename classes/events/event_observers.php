...
namespace local_kdashboard\events;
 ...
 *
 * @package local_kdashboard\events
 */
class event_observers {
    ...
    public static function process_event(\core\event\base $event) {
        ...
        $kopereeventss = $DB->get_records("local_kdashboard_event", $where);

        /** @var local_kdashboard_event $kopereevents */
        foreach ($kopereeventss as $kopereevents) {
            $sendevents = new send_events();
            $sendevents->set_event($event);
            $sendevents->set_local_kdashboard_event($kopereevents);
