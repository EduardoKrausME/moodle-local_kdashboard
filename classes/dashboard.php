...
class dashboard {
    ...
    public function monitor() {
        echo '
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <div class="element-box color_user">
                            ...
                            <div class="value"><a href="' . local_kdashboard_makeurl("users", "dashboard") . '">
                    ...
                    <div class="col-sm-3">
                        <div class="element-box color_online">
                            ...
                            <div class="value"><a href="' . local_kdashboard_makeurl("useronline", "dashboard") . '">
                    ...
                    <div class="col-sm-3">
                        <div class="element-box color_course">
                            ...
                            <div class="value"><a href="' . local_kdashboard_makeurl("courses", "dashboard") . '">
            ...
            local_kdashboard_makeurl("reports", "dashboard", ["type" => "server"]) . '">
    ...
    public function last_grades() {
        ...
        foreach ($lastgrades as $grade) {
            ...
            $data = [
                ...
                "users_details" => local_kdashboard_makeurl("users", "details", ["userid" => $user->id]),
                "users_details_ajax" => local_kdashboard_makeurl("users", "details", ["userid" => $user->id], "view-ajax"),
