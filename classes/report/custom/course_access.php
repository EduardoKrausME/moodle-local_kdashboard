...
namespace local_kdashboard\report\custom;

use local_kdashboard\html\button;
use local_kdashboard\task\db_course_access;
 ...
 * Class course_access
 *
 * @package local_kdashboard\report\custom
 */
class course_access {
    ...
    public function generate() {
        global $DB, $CFG;
        $count = $DB->get_record_sql("SELECT COUNT(*) AS registros FROM {local_kdashboard_acess}");
