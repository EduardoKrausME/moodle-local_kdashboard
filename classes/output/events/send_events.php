...
namespace local_kdashboard\output\events;
 ...
 * Class send_events
 *
 * @package local_kdashboard\output\events
 */
class send_events {
     ...
     *
     * @return local_kdashboard_event
     */
    public function get_local_kdashboard_event() {
        return $this->koperedashboardevents;
    }

    /**
     * Function set_local_kdashboard_event
     *
     * @param $kopereevents
     */
    public function set_local_kdashboard_event($kopereevents) {
