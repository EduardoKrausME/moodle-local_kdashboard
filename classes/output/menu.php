...
namespace local_kdashboard\output;

use local_kdashboard\reports;
use local_kdashboard\util\dashboard_util;
use local_kdashboard\util\menu_util;
use local_kdashboard\util\submenu_util;

/**
 * Class menu
 *
 * @package local_kdashboard\output
 */
class menu {
