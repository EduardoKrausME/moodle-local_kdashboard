...
(function(factory) {
    if (typeof define === 'function' && define.amd) {
        // AMD
        define(["jquery", "local_kdashboard/jszip", "local_kdashboard/dataTables", "local_kdashboard/dataTables.buttons"],
            function($, jszip,) {
                window.JSZip = jszip;
        ...
        var cjsRequires = function(root, $) {
            if (!$.fn.dataTable) {
                require("local_kdashboard/dataTables")(root, $);
            }

            if (!$.fn.dataTable.Buttons) {
                require("local_kdashboard/dataTables.buttons")(root, $);
            }
        };
            ...
            action: function(e, dt, button, config) {
                ...
                if (document.queryCommandSupported('copy')) {
                    ...
                    try {
                        ...
                        if (successful) {
                            dt.buttons.info(
                                M.util.get_string('datatables_buttons_copy_text', "local_kdashboard"),
                                dt.i18n(
                                    'buttons.copySuccess',
                                    {
                                        1: M.util.get_string('datatables_buttons_copySuccess1', "local_kdashboard"),
                                        _: M.util.get_string('datatables_buttons_copySuccess_', "local_kdashboard"),
                                    },
                                    exportData.rows
                                ),
                                2000
